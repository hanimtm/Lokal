...
class ResConfigSettings(models.TransientModel):
    ...
    create_shopify_vendors_webhook = fields.Boolean("Manage Shopify Vendors via Webhooks",
                                                      help="True : It will create all vendor related webhooks.\n"
                                                           "False : All vendor related webhooks will be deactivated.")
